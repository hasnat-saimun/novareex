 @extends('frontend.dashboard.include') @section('frontBody')
        ...
        <div class="section-title">
            <h2 class="title"><span>Services</span> We offer</h2>        </div>
...
<button class="swiper-nav__btn testimonial__slider-next active"><i class="fas fa-angle-right"></i></button>
		...
		<div class="elementor-element elementor-element-1b99884 e-con-full e-flex e-con e-child" data-id="1b99884" data-element_type="container">
				...
				<div class="elementor-widget-container">
															<img fetchpriority="high" decoding="async" width="244" height="235" src="../wp-content/uploads/2023/10/cta-2.png" class="attachment-full size-full wp-image-312" alt="" />															</div>
				</div>
				</div>
