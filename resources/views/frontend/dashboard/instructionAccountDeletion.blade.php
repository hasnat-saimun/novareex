            ...
            <section class="breadcrumb-area bg--cover" style="background-image: url({{ asset('public/novareex/bitrader.thetork.com/') }}/wp-content/uploads/2024/06/breadcrumb_bg-1.png);">
                <div class="container">
                    <div class="breadcrumb-area__content">
                        <h2 class="mt-5">How to delete account</h2>
                        <nav aria-label="breadcrumb" class="breadcrumb">
                            ...
                            &gt;
                            <span property="itemListElement" typeof="ListItem">
                                <span property="name" class="post post-page current-item">How to delete account</span><meta property="url" content="https://bitrader.thetork.com/about-us/" /><meta property="position" content="2" />
                            </span>
                        </nav>
                    </div>
