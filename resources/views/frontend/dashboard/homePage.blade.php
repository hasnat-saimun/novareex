...
<div data-elementor-type="wp-page" data-elementor-id="646" class="elementor elementor-646">
            ...
            <div class="elementor-widget-container">
                ...
                <section class="banner banner--style3 tg-section">
                            ...
                            <div class="row gy-5 gx-4 align-items-end">
                                <div class="col-lg-5 col-md-5">
                                    <div class="banner__content tg-content" data-aos="fade-right" data-aos-duration="1000">
                                        <div class="banner__content-coin banner__content-coin--style2">
                                            <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2025/02/2-2.png" alt="Coin icon" />
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="banner__thumb">
                                        <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2025/02/1-1.png" alt="" />
                                    </div>
                                </div>
                    ...
                    <div class="banner__shape">
                        <span class="banner__shape-item banner__shape-item--3"><img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2025/02/1-2.png" width="106" alt="shape icon" /></span>

                        <span class="banner__shape-item banner__shape-item--4"><img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2025/02/2-1.png" width="48" alt="shape icon" /></span>
                    </div>
                </section>
            </div>
        </div>
                            ...
                            <div class="row g-4 align-items-center">
                                    ...
                                    <div class="feature__item" data-aos="fade-up" data-aos-duration="800">
                                        <div class="feature__item-inner text-center">
                                            <div class="feature__item-thumb">
                                                <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/features_icon01.png" alt="Icon" />
                                            </div>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="feature__item" data-aos="fade-up" data-aos-duration="800">
                                        <div class="feature__item-inner text-center">
                                            <div class="feature__item-thumb">
                                                <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/features_icon02.png" alt="Icon" />
                                            </div>
                                            <div class="feature__item-content">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="feature__item" data-aos="fade-up" data-aos-duration="800">
                                        <div class="feature__item-inner text-center">
                                            <div class="feature__item-thumb">
                                                <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/features_icon03.png" alt="Icon" />
                                            </div>
                                            <div class="feature__item-content">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="feature__item" data-aos="fade-up" data-aos-duration="800">
                                        <div class="feature__item-inner text-center">
                                            <div class="feature__item-thumb">
                                                <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/features_icon04.png" alt="Icon" />
                                            </div>
                                            <div class="feature__item-content">
        ...
        <div class="e-con-inner">
                        ...
                        <div class="about__thumb" data-aos="fade-right" data-aos-duration="800">
                            <div class="about__thumb-inner">
                                <div class="about__thumb-image text-center floating-content">
                                    <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/about_img_light-2.png" alt="" />
                                    <div class="floating-content__bottom-left floating-content__bottom-left--style3">
                                        <div class="floating-content__item floating-content__item--style4">
                                            <div class="floating-content__item-thum">
                                                <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/about_author.png" width="65" alt="Author" />
                                            </div>
            ...
            <div class="elementor-element elementor-element-791e829 e-con-full e-flex e-con e-child" data-id="791e829" data-element_type="container">
                <div class="elementor-element elementor-element-09405ca elementor-widget elementor-widget-image" data-id="09405ca" data-element_type="widget" data-widget_type="image.default">
                    <div class="elementor-widget-container">
                        <img decoding="async" width="104" height="52" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/banner3-2.png" class="attachment-full size-full wp-image-652" alt="" />
                    </div>
                </div>
                ...
                <div class="elementor-element elementor-element-470629f elementor-widget elementor-widget-heading" data-id="470629f" data-element_type="widget" data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                        <p class="elementor-heading-title elementor-size-default">
                            Hey folks! Meet our platform! With our platform, you'll get access to all the info you need to make informed decisions. Our platform is your one-stop-shop for everything you need to know. So what are you waiting
                ...
                <div class="elementor-element elementor-element-4a724ea elementor-widget elementor-widget-tg-btn" data-id="4a724ea" data-element_type="widget" data-widget_type="tg-btn.default">
                    <div class="elementor-widget-container">
                        <div class="myclass1">
                            <a href="{{asset('/public/novareex/')}}/bitrader.thetork.com/about-us/index.html" target="_self" rel="nofollow" class="trk-btn trk-btn--border trk-btn--primary"> Explore More </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="e-con-inner">
            <div class="elementor-element elementor-element-e4290e9 e-con-full e-flex e-con e-child" data-id="e4290e9" data-element_type="container">
                ...
                <div class="elementor-element elementor-element-d1cb889 elementor-widget elementor-widget-tg-btn" data-id="d1cb889" data-element_type="widget" data-widget_type="tg-btn.default">
                    <div class="elementor-widget-container">
                        <div class="myclass1">
                            <a href="{{asset('/public/novareex/')}}/bitrader.thetork.com/our-team/index.html" target="_self" rel="nofollow" class="trk-btn trk-btn--border trk-btn--primary"> Meet our experts </a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="elementor-element elementor-element-0569b3c elementor-widget elementor-widget-genix-image" data-id="0569b3c" data-element_type="widget" data-widget_type="genix-image.default">
                    <div class="elementor-widget-container">
                        ...
                        <div class="about__thumb" data-aos="fade-left" data-aos-duration="800">
                            <div class="about__thumb-inner">
                                <div class="about__thumb-image text-center floating-content">
                                    <img decoding="async" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/about_img_light02-2.png" alt="" />
            ...
            >
                <div class="elementor-widget-container">
                    <img
                        ...
                        width="150"
                        height="75"
                        src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/pricing_wave-2.png"
                                    ...
                                    <div class="testimonial__item testimonial__item--style1">
                                        <div class="testimonial__item-inner">
                                            <div class="testimonial__item-content">
                                                <p class="mb-0">
                                                    The above testimonial is about Martha Chumo, who taught herself to code in one summer. This testimonial example works because it allows prospective customers to see themselves in
    ...
    <div class="elementor-element elementor-element-557da09 e-flex e-con-boxed e-con e-parent" data-id="557da09" data-element_type="container">
        <div class="e-con-inner">
            ...
            >
                <div class="elementor-widget-container">
                    <img loading="lazy" decoding="async" width="162" height="101" src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/faq_wave-2.png" class="attachment-full size-full wp-image-702" alt="" />
                </div>
            </div>
                        ...
                        <div class="elementor-element elementor-element-223e69f elementor-widget elementor-widget-image" data-id="223e69f" data-element_type="widget" data-widget_type="image.default">
                            <div class="elementor-widget-container">
                                <img
                                    ...
                                    width="537"
                                    height="493"
                                    src="{{asset('/public/novareex/')}}/bitrader.thetork.com/wp-content/uploads/2023/10/faq_img002-2.png"
                                    ...
                                    <div class="blog__item home-blog-post blog__item--style2">
                                        <div class="blog__item-inner">
                                            ...
                                            <div class="blog__content">
                                                ...
                                                <h5 class="10">
                                                    <a href="{{asset('/public/novareex/')}}/bitrader.thetork.com/online-trading-for-beginners/index.html">Online trading for beginners</a>
                                                </h5>
